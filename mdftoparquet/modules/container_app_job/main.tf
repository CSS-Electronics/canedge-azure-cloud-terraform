...
# Note: No explicit diagnostic settings needed. Logs are automatically collected when the
# Container App Environment has a log_analytics_workspace_id specified.
